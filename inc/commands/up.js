...
/**
 * The up command will bring one or all of the applications up and start them.
 *
        ...
        return new Promise(function (resolve, reject) {
            ...
            async.each(toActUpon, function (application, next) {
                ...
                if (toActUpon.length === 0) {
                    return reject(new Error('All the necessary containers are already up!'));
                }
